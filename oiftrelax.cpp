...
int main(int argc, char **argv) {
    ...
    /*
    W = gft::Scene32::SobelFilter(scn);
    gft::ift::OIFT(W, A, scn, pol*100.0, S, label);
    gft::ift::ORelax_1(W, A, scn, pol*100.0, S, label, niter);
    gft::Scene32::Destroy(&W);
    */
    ...
    /*
    Wx = gft::Scene32::SobelFilterX(scn);
    Wy = gft::Scene32::SobelFilterY(scn);
    Wz = gft::Scene32::SobelFilterZ(scn);
    for(p = 0; p < scn->n; p++){
      Wx->data[p] = abs(Wx->data[p]);
      Wy->data[p] = abs(Wy->data[p]);
      Wz->data[p] = abs(Wz->data[p]);
    }
    gft::ift::OIFT(Wx, Wy, Wz, scn, pol*100.0, S, label);
    gft::ift::ORelax_1(Wx, Wy, Wz, scn, pol*100.0, S, label, niter);
    gft::Scene32::Destroy(&Wx);
    gft::Scene32::Destroy(&Wy);
    gft::Scene32::Destroy(&Wz);
    */
